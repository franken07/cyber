    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
          <li class="nav-item">
            <a class="nav-link link text-black display-4" href="#">Components</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link link text-black display-4" href="contact.html">Contacts</a>
          </li>
        </ul>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="content-wrap col-12 col-md-10">
        ...
        <p class="mbr-fonts-style mbr-text mbr-white mb-4 display-7">Unleash Your PC&#x27;s Potential with Top-Notch Parts and Expert Services. Book Your Appointment Today!</p>
      </div>
    </div>
  </div>
</section>
