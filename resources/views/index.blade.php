...
<head>
  ...
  <title>csd</title>
  <link rel="stylesheet" href="https://cyberservice-96805b7c1a96.herokuapp.com/assets/web/assets/mobirise-icons2/mobirise2.css">
  <link rel="stylesheet" href="https://cyberservice-96805b7c1a96.herokuapp.com/assets/parallax/jarallax.css">
  <link rel="stylesheet" href="https://cyberservice-96805b7c1a96.herokuapp.com/assets/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="https://cyberservice-96805b7c1a96.herokuapp.com/assets/bootstrap/css/bootstrap-grid.min.css">
  <link rel="stylesheet" href="https://cyberservice-96805b7c1a96.herokuapp.com/assets/bootstrap/css/bootstrap-reboot.min.css">
  <link rel="stylesheet" href="https://cyberservice-96805b7c1a96.herokuapp.com/assets/dropdown/css/style.css">
  <link rel="stylesheet" href="https://cyberservice-96805b7c1a96.herokuapp.com/assets/socicon/css/styles.css">
  <link rel="stylesheet" href="https://cyberservice-96805b7c1a96.herokuapp.com/assets/animatecss/animate.css">
  <link rel="stylesheet" href="https://cyberservice-96805b7c1a96.herokuapp.com/assets/theme/css/style.css">
  <link rel="preload" href="https://fonts.googleapis.com/css2?family=Inter+Tight:wght@400;700&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">
  <noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Inter+Tight:wght@400;700&display=swap"></noscript>
  <link rel="preload" as="style" href="https://cyberservice-96805b7c1a96.herokuapp.com/assets/mobirise/css/additional.css"><link rel="stylesheet" href="assets/mobirise/css/additional.css" type="text/css">
...
<section class="header16 cid-u3GZCsGLCS mbr-fullscreen mbr-parallax-background" id="hero-17-u3GZCsGLCS">
    ...
    <div class="row">
      <div class="content-wrap col-12 col-md-10">
        <h1 class="mbr-section-title mbr-fonts-style mbr-white mb-4 display-1">
          <strong>CYBER SERVICE DEN</strong>
        </h1>
        <H5 class="mbr-fonts-style mbr-text mbr-white mb-4 display-7">Unleash Your PC&#x27;s Potential with Top-Notch Parts and Expert Services. Book Your Appointment Today!</h5>
      </div>
 ...
 <!--####################### Feature Starts Here ###################-->
<section class="people03 cid-u3GZCsGM5B" id="feature">
	<div class="container-fluid">
 ...
 <!--####################### Cards Starts Here ###################-->
		<div class="row">
          ...
          <div class="item-wrapper">
            <div class="item-img mb-3">
              <img src="images/rog4090.jpg">
            </div>
            <div class="item-content align-left">
              <h6 class="item-subtitle mbr-fonts-style display-5">
                <strong>RTX 4090</strong>
              </h6>
              <p class="mbr-text mbr-fonts-style display-7">$1,799.99 </p>
            </div>
          </div>
      </div>
      ...
      <div class="item features-image col-12 col-md-6 col-lg-3">
          <div class="item-wrapper">
            ...
            <div class="item-content align-left">
              <h6 class="item-subtitle mbr-fonts-style display-5">
                <strong>Acer Nitro 165</strong>
              </h6>
              <p class="mbr-text mbr-fonts-style display-7">$159.99</p>
            </div>
          </div>
      </div>
      ...
      <div class="item features-image col-12 col-md-6 col-lg-3">
          <div class="item-wrapper">
            <div class="item-img mb-3">
              <img src="images/acer-nitro.jpg">
            </div>
            <div class="item-content align-left">
              <h6 class="item-subtitle mbr-fonts-style display-5">
                <strong>Intel Core i9-14900K</strong>
              </h6>
              <p class="mbr-text mbr-fonts-style display-7">$549.99</p>
            </div>
          </div>
      </div>
      ...
      <div class="item features-image col-12 col-md-6 col-lg-3">
          <div class="item-wrapper">
            <div class="item-img mb-3">
              <img src="images/ramm.png">
            </div>
            <div class="item-content align-left">
              <h6 class="item-subtitle mbr-fonts-style display-5">
                <strong>T-FORCE VULCAN</strong>
              </h6>
              <p class="mbr-text mbr-fonts-style display-7">$35.99</p>
            </div>
          </div>
      </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 content-head">
                <div class="mbr-section-head mb-5">
                    <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                        <strong>Top Picks for Your Ultimate Build</strong>
                    </h4>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="item features-image col-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/rog-monitor.jpg" >
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5">
                            <strong>ROG Strix XG27AQV</strong>
                        </h5>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Unleash the Power of Gaming with Lightning Speed
                        </p>
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/4090-founders.jpg">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5">
                            <strong>GeForce RTX 4090</strong>
                        </h5>
                        <p class="mbr-text mbr-fonts-style display-7">
                          Experience ultra-high performance gaming, incredibly detailed virtual worlds, unprecedented productivity, and new ways to create.
                        </p>
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    ...
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5">
                            <strong>Trident Z RGB</strong>
                        </h5>
                        <p class="mbr-text mbr-fonts-style display-7">
                          Featuring the award-winning Trident Z heatspreader design, the Trident Z RGB memory series combines vivid RGB lighting with awesome DDR4 DRAM performance.<br>
                        </p>
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/rayzen.jpg">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-5">
                            <strong>AMD Ryzen™ 7</strong>
                        </h5>
                        <p class="mbr-text mbr-fonts-style display-7">
                         Enjoy the benefits of next-gen AMD 3D V-Cache™ technology for low latency and even more game performance.<br>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2 active">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/AMD-Logo.png" data-slide-to="1" data-bs-slide-to="1">
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/Asus-Logo.png" data-slide-to="2" data-bs-slide-to="2">
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/giga.png" data-slide-to="3" data-bs-slide-to="3">
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/acer-logo-black-editorial-on-white-background-free-vector.jpg" data-slide-to="4" data-bs-slide-to="4">
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/Corsair-logo.png" data-slide-to="5" data-bs-slide-to="5">
                    </div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-sm-6 col-lg-2">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="images/Crucial-Logo.png" data-slide-to="6" data-bs-slide-to="6">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8 side-features">
                <div class="item-wrapper align-left">
                    <div class="counter-container mbr-text mbr-fonts-style display-7">
                        <ul>
                          <li>Discover the art of PC building and create a powerhouse that reflects your style and passion.</li>
                          <li>Learn the tips and tricks of maintenance to keep your rig running smoothly and efficiently at all times.</li>
                          <li>Explore the world of overclocking and push your hardware to its limits for unparalleled performance.</li>
                          <li>Dive into the realm of RGB lighting and customize your setup to dazzle and impress with vibrant colors and effects.</li>
                          <li>Master cable management techniques to achieve a clean and organized build that showcases your attention to detail.</li>
                        </ul>
                    </div>
                </div>
            </div>
					...
					<div id="bootstrap-accordion_0" class="panel-group accordionStyles accordion" role="tablist" aria-multiselectable="true">
							...
							<div id="collapse1_0" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" data-bs-parent="#bootstrap-accordion_0">
								<div class="panel-body">
									<p class="mbr-fonts-style panel-text display-7">
										Selecting the perfect components for your PC can be daunting, but fear not! Our experts are here to guide you through the process and help you make informed decisions based on your needs and budget.
									</p>
								</div>
							</div>
						</div>
						<div class="card mb-3">
							...
							<div id="collapse2_0" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" data-bs-parent="#bootstrap-accordion_0">
								<div class="panel-body">
									<p class="mbr-fonts-style panel-text display-7">
										While we don&#x27;t provide installation services, we offer comprehensive tutorials and guides to assist you in assembling your PC like a pro. You&#x27;ll be a master builder in no time!
									</p>
								</div>
							</div>
						</div>
						<div class="card mb-3">
							...
							<div id="collapse3_0" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" data-bs-parent="#bootstrap-accordion_0">
								<div class="panel-body">
									<p class="mbr-fonts-style panel-text display-7">
										We stand by the quality of our products and offer a solid warranty to ensure your peace of mind. Rest easy knowing that your investment is protected against any unforeseen issues.
									</p>
								</div>
							</div>
						</div>
						<div class="card mb-3">
							...
							<div id="collapse4_0" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" data-bs-parent="#bootstrap-accordion_0">
								<div class="panel-body">
									<p class="mbr-fonts-style panel-text display-7">
										Absolutely! We believe in the power of personalization. Mix and match components to create a setup that&#x27;s uniquely yours and tailored to meet your specific requirements.
									</p>
								</div>
							</div>
						</div>
						<div class="card mb-3">
							...
							<div id="collapse5_0" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" data-bs-parent="#bootstrap-accordion_0">
								<div class="panel-body">
									<p class="mbr-fonts-style panel-text display-7">
										Our support team is available 24/7 to assist you with any queries or concerns. Reach out to us via email, phone, or live chat for prompt and reliable assistance.
									</p>
								</div>
							</div>
						</div>
