        ...
        <div class="card col-md-12 col-lg-10">
          <div class="card-wrapper">
            <div class="card-content-text">
              <h3 class="card-title mbr-fonts-style mbr-white mt-3 mb-4 display-2" style="text-align: center;">
                  <strong>Cyber Service Den</strong>
              </h3>
            <div class="row card-box align-left">
              <div class="item features-without-image col-12">
                <div class="item-wrapper">
                  <p class="mbr-text mbr-fonts-style display-7">Welcome to the ultimate tech paradise where your PC dreams come true! Dive into a world of cutting-edge components and unleash the power of your rig like never before.</p>
                </div>
              </div>
              <div class="item features-without-image col-12">
                <div class="item-wrapper">
                  <p class="mbr-text mbr-fonts-style display-7">At CSD, we&#x27;re obsessed with performance, quality, and pushing the boundaries of what&#x27;s possible in the PC world. Join us on this epic journey to elevate your gaming and work experience to new heights!</p>
                </div>
              </div>
              <div class="item features-without-image col-12">
                <div class="item-wrapper">
                  <p class="mbr-text mbr-fonts-style display-7">Explore our vast selection of PC parts, from processors to graphics cards, and experience the thrill of building your dream machine with us.</p>
                </div>
              </div>
            </div>
            </div>
            <div class="image-wrapper d-flex justify-content-center mt-3">
              <img src="assets/images/rex.jpeg">
            </div>
          </div>
        </div>
      </div>
